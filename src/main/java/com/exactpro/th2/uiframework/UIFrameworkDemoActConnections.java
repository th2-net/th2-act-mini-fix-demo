...
public class UIFrameworkDemoActConnections extends ActConnections<UIFrameworkDemoConfigurations> {
	...
	@Override
	protected UIFrameworkDemoConfigurations createCustomConfiguration(CommonFactory commonFactory) {
		return commonFactory.getCustomConfiguration(UIFrameworkDemoConfigurations.class);
	}
}
