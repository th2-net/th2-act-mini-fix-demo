...
public class CloseApplication extends BaseAction<BaseMessage> {
	private static final Logger logger = LoggerFactory.getLogger(CloseApplication.class);


	public CloseApplication(UIFrameworkDemo framework, StreamObserver<ActResponse> responseObserver) {
