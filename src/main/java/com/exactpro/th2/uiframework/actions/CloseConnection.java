...
public class CloseConnection extends BaseAction<BaseMessage> {
	private static final Logger logger = LoggerFactory.getLogger(CloseConnection.class);


	public CloseConnection(UIFrameworkDemo framework, StreamObserver<ActResponse> responseObserver) {
	...
	protected void collectActions(BaseMessage request, UIFrameworkDemoContext context, ActResult result) throws UIFrameworkException {
		context.getMainWindow().closeConnection();
	}
